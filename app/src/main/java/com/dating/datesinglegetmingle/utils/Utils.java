package com.dating.datesinglegetmingle.utils;
...
import com.dating.datesinglegetmingle.Activity.Login;
...
public class Utils {
    ...
    public static void openAlertDialog(Context context, String message) {
        ...
        builder.setTitle("Date Single get mingle");
        ...
        try {
            if (pgdialog != null)
                if (pgdialog.isShowing())
                    pgdialog.dismiss();
            pgdialog = ProgressDialog.show(mContext, "Date Single get mingle", strMessage, true);
        } catch (Exception e) {
            e.printStackTrace();
            pgdialog.dismiss();
        }
